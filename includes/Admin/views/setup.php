<div>
	...
	<form method="post" action="options.php" id="pathao-setup">
		<table class="form-table">
			...
			<tr>
				...
				<td>
					<input class="regular-text" id="pathao_client_id" type="text"
						   value="<?php echo esc_html( get_option( 'pathao_client_id' ) ); ?>" required />
				</td>
			</tr>
			<tr>
				<th scope="row">
				...
				<td>
					<input class="regular-text" id="pathao_client_secret" type="text"
						   value="<?php echo esc_html( get_option( 'pathao_client_secret' ) ); ?>" required />
				</td>
			</tr>
			<tr>
				<th scope="row">
	...
	<table class="form-table">
		...
		<tr>
			...
			<td>
				<textarea readonly class="large-text" name="pathao_access_token" id="pathao_access_token" cols="80"
						  rows="10"><?php echo get_option( 'pathao_access_token' ); ?></textarea>
		...
		<tr>
			...
			<td>
				<textarea readonly class="large-text" name="pathao_refresh_token" id="pathao_refresh_token" cols="80"
						  rows="10"><?php echo get_option( 'pathao_refresh_token' ); ?></textarea>
