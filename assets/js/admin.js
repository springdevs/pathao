jQuery(document).ready(function ($) {
  $('#pathao-setup').on('submit', async function (e) {
    ...
    await $.ajax({
      ...
      success: function (res) {
        if (res.success) {
          $('.pathao-notice').after('<div class="notice notice-success is-dismissible"><p><b>Token generated successfully !!</b></p><button id="dismiss-message" class="notice-dismiss" type="button"><span class="screen-reader-text">Dismiss this notice.</span></button></div>');
          ...
          $('.pathao-notice').after('<div class="notice notice-error is-dismissible"><p><b>' + res.data.message + '</b></p><button id="dismiss-message" class="notice-dismiss" type="button"><span class="screen-reader-text">Dismiss this notice.</span></button></div>');
          $('#dismiss-message').click(function (event) {
            event.preventDefault();
  ...
  $("#pathao_city").on("change", function () {
    ...
    $.ajax({
      ...
      success: function (res) {
        $("#pathao_zone").html("");
        $("#pathao_zone").append("<option value=''>Select Zone</option>");
        $.each(res, function (key, value) {
          $("#pathao_zone").append('<option value="' + value.zone_id + '">' + value.zone_name + '</option>');
        });
  ...
  $("#pathao_zone").on("change", function () {
    ...
    $.ajax({
      ...
      success: function (res) {
        $("#pathao_area").html("");
        $("#pathao_area").append("<option value=''>Select Area</option>");
        $.each(res, function (key, value) {
          $("#pathao_area").append('<option value="' + value.area_id + '">' + value.area_name + '</option>');
        });
